This folder contains NNs trained using Mean Squared  Error as loss function on a hypercube that is applicable to all devices with aspect ratio R/a>3 and only for pure deuterium plasmas.
Quick facts:
...
- Theordering of the input variables must be as follows:  `RLNS\_1`,`RLTS\_1`,`RLTS\_2`,`TAUS\_2`,`RMIN\_LOC`,`DRMAJDX\_LOC`,`Q\_LOC`,`SHAT`,`XNUE`,`KAPPA\_LOC`,`DELTA\_LOC`,`ZEFF`,`VEXB\_SHEAR`, `BETAE`
