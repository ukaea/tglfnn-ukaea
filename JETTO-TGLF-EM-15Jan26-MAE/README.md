This folder contains NNs trained using Mean Absolute Error as loss function on a hypercube that is applicable to all devices with aspect ratio R/a>3 and for a DT  plasmas.
Quick facts:
